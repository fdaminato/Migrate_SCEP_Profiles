...
param(
    ...
    [string]$Step1SourceGroupId = '75a45b99-1bcf-481e-bd74-fa9e8f5e6226',

    # Step 2: devices waiting for both 802.1X profiles to succeed.
    [Parameter()]
    [ValidatePattern('^[0-9a-fA-F-]{36}$')]
    [string]$Step2GroupId = 'fa07710a-7da5-41be-87b4-5bf74263cfa6',

    # Step 3: devices where both 802.1X profiles succeeded.
    [Parameter()]
    [ValidatePattern('^[0-9a-fA-F-]{36}$')]
    [string]$Step3GroupId = 'e44de38b-a3f2-4ced-b56a-056b75a02dd7',

    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string]$CertificatePolicyName = 'SCEP Computer Certificate (HAADJ) - Temporary 1 month validity',
